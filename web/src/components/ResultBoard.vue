<template>
    <div class="result-board">
        ...
        <div class="result-board-text"
            v-else-if="$store.state.pk.loser === 'A' && $store.state.pk.b_id === parseInt($store.state.user.id)">
            胜利
        </div>
        <div class="result-board-text"
        ...
        <div class="result-board-btn">
            <button @click="restart" type="button" class="btn btn-warning btn-lg">退出界面</button>
        </div>
    </div>
</template>
